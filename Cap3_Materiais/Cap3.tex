...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Processo de obtenção da peça negra} \label{ssec:materiais_CS_carbonitruracao}
...
% \begin{figure}[htb]
%     \centering
%     \includegraphics[width = 0.6\textwidth]{Figures/Cap3/Falta_Imagem.png}
%     \caption[Roda de coroa DB45 após pré-oxidação]%
%     {Imagem de uma coroa de série DB45 após tratamento de pré-oxidação.}
%     \label{fig:apos_pre_ox}
% \end{figure}
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par
...
\newpage
\par
Para a realização das medições de dureza no Laboratório de Ensaios Mecânicos (LEMM) foram removidas as rodas de coroa de baixo, ou Nº 1, do meio, ou Nº 6 e de cima, ou Nº 10. Foram feitas filiações das zonas de soldadura do diferencial, denominadas por “Zona 1”, zonas de prensagem, denominadas por “Zona 2”, zonas de soldadura da “Cible”, denominada por “Zona 3” e nas zonas do topo de soldadura, denominada por “Zona 4”, na zona do dentado, e a dureza superficial. A Figura \ref{fig:zonas_filiacoes_dureza} ilustra, num desenho de uma roda de coroa DB45, a posição das zonas das filiações de dureza.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[htb!]
    \centering
    \includegraphics[width = 0.5\textwidth]{Figures/Cap3/Falta_Imagem.png}
...
Devido aos problemas encontrados no ensaio do protótipo inicial, foram desenvolvidos dois outros protótipos. O primeiro, denominado “Tampa O” sendo uma modificação do protótipo inicial, apenas com a adição de uma aba de proteção para a cible. O segundo, alterando a geometria de um “copo” para um formato ajustado à torre da ferramenta porta-peças das peças de série, denominado “Tampa Y”. A Figura \ref{fig:novos_prototipos} ilustra as geometrias novas. A ferramenta inicial foi então denominada “Tampa P”, em homenagem ao “Eng. Pinto” responsável pela sua geometria e pela ideia de proteger as rodas de coroa quanto à Têmpera.
\begin{figure}[htb]
    \centering
    \begin{subfigure}{.5\textwidth}\
        \centering
...
\begin{figure}[htb!]
    ...
    {Desenho indicativo da configuração das ferramentas num prato para realização do ensaio com os vários protótipos. Em cima à esquerda, a tampa Y, em cima à direita a tampa O, em baixo à esquerda, a ferramenta sem tampa; em baixo à direita, a tampa P; e no centro, uma coluna de série.}
