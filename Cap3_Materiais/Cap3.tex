...
\begin{figure}[htb!]
    ...
    \caption[Fotografia das galés que foram inseridas na carga de ensaio]%
    {Fotografia das galés que foram inseridas na carga de ensaio.\\ dimensões aproximadas: diâmetro - 50mm; espessura - 20mm.}
    \label{fig:gales}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par
