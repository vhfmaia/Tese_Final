...
\begin{figure}[htb]
    \centering
    \includegraphics[width = 0.6\textwidth]{Figures/Cap3/resultado_serie.png}
...
Como dito na subsecção anterior, foi desenvolvida uma nova ferramenta porta-peças onde se aproveitou a falsa coroa, a torre e o prato, foi adicionado um copo para permitir a soldadura da torre na falsa coroa. A imagem da ferramenta porta-peças em corte, com uma coluna de rodas de coroa DB45 montada pode ser vista na Figura \ref{fig:simples_montada}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[htb]
    \centering
    \includegraphics[width = 0.6\textwidth]{Figures/Cap3/Simples_montada.png}
    \caption[Vista em corte da ferramenta porta-peças proposta]%
    {Imagem de um corte no plano XZ, a meio da coluna de rodas de coroa montada, da solução proposta para a ferramenta-porta peças que protege o diâmetro interno dessas rodas de coroa.}
