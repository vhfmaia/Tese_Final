...
\input{User_Doc_Def}   % definições de informação do trabalho (autor, título, orientação, júri, etc ***(definir essa informação neste ficheiro)***
...
% -------------------------------------------------------------
\begin{document}
    \include{packMEM/MEM22_begin.tex}  %preâmbulo geral do documento 

% ----------------------------------------------------------------
% Corpo da tese
% ----------------------------------------------------------------
    \input{Cap1_Intro/Cap1}
    \input{Cap2_SOA/Cap2}
    \input{Cap3_Materiais/Cap3}
    \input{Cap4_Resultados/Cap4}
    \input{Cap5_Conclusao/Cap5}
